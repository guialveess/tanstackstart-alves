...
import { createRootRoute, HeadContent, Outlet, Scripts, createFileRoute, lazyRouteComponent, RouterProvider, createRouter as createRouter$1, useRouter, useMatch, rootRouteId as rootRouteId$1, ErrorComponent, Link } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DJ4MLYd0.mjs');
...
const appCss = "/assets/app-CqOH05J9.css";
...
function RootComponent() {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      ...
      /* @__PURE__ */ jsx("title", { children: "guialvees" }),
      /* @__PURE__ */ jsx(HeadContent, {})
    ] }),
    /* @__PURE__ */ jsxs("body", { className: "dark", children: [
      /* @__PURE__ */ jsx(Outlet, {}),
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$5 = () => import('./x0-B2kYzwM6.mjs');
const Route$5 = createFileRoute("/x0")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import('./love-CilL67vY.mjs');
const Route$4 = createFileRoute("/love")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./custom-dithering-7VIdgftC.mjs');
const Route$3 = createFileRoute("/custom-dithering")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./cat-9PK0ApdC.mjs');
const Route$2 = createFileRoute("/cat")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import('./about-cNlHBH86.mjs');
const Route$1 = createFileRoute("/about")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import('./index-D9Ov0C2f.mjs');
const Route = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const X0Route = Route$5.update({
  id: "/x0",
  path: "/x0",
  getParentRoute: () => Route$6
});
const LoveRoute = Route$4.update({
  id: "/love",
  path: "/love",
  getParentRoute: () => Route$6
});
const CustomDitheringRoute = Route$3.update({
  id: "/custom-dithering",
  path: "/custom-dithering",
  getParentRoute: () => Route$6
});
const CatRoute = Route$2.update({
  id: "/cat",
  path: "/cat",
  getParentRoute: () => Route$6
});
